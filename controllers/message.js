...
const model = genAI.getGenerativeModel({ 
    ...
    systemInstruction: `You are an expert doctor and nutritionist specializing in diagnosing symptoms, creating personalized diet plans, and providing health advice. 
...
// test route
const messageAi = async (req, res) => {
  const chat = model.startChat({
      history: [
        {
          role: "user",
          parts: [{ text: "Hello, i am rahul suffering from fever" }],
        },
      ],
    });
...
module.exports = {messageAi}



// global context => age, ht, wt, diseases
    // diagnosis (symptoms) => disease, food plan, precautions
    // diet (preferences, goals) => proper diet plan
    // workout (number of days, types) => workout plan